# Sample Menu Script with Multiple Prices (Horizontal Display)
...
# Function to display the menu horizontally
def display_menu():
    print("Welcome to the Café!")
    print("Here is our menu:")
    for item, sizes in menu.items():
        size_prices = ', '.join([f"{size}: ${price:.2f}" for size, price in sizes.items()])
        print(f"{item}: {size_prices}")
